...
Each component gets a doc page via `/docs/[slug].astro` or `/sections/[slug].astro` with:
  ...
  3. **Installation**: step-by-step instructions for manual integration
  4. **Usage**: clear import statements and code block showing how to use the component (and its sub-components if applicable)
  5. **Component Code**: full source code with a copy button
...
## Specialized Workflows & Agent Roles

Detailed step-by-step procedures and specialized technical skills are maintained in [`.agents/`](file:///.agents/):

- **Component Creation**: [`.agents/workflows/component-creator.md`](file:///.agents/workflows/component-creator.md)
- **Code Review**: [`.agents/workflows/component-reviewer.md`](file:///.agents/workflows/component-reviewer.md)
- **QA & Accessibility (a11y/WCAG)**: [`.agents/workflows/qa-accessibility.md`](file:///.agents/workflows/qa-accessibility.md)
- **Documentation & Registry**: [`.agents/workflows/documentation-agent.md`](file:///.agents/workflows/documentation-agent.md)
- **Section Creator**: [`.agents/workflows/sections-creator.md`](file:///.agents/workflows/sections-creator.md)
- **Refactoring Guide**: [`.agents/workflows/refactoring-agent.md`](file:///.agents/workflows/refactoring-agent.md)
- **Three.js Technical Reference Skill**: [`.agents/skills/threejs-guide/SKILL.md`](file:///.agents/skills/threejs-guide/SKILL.md)
